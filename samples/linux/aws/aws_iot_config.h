...
// Secure Element configs
#define MBEDTLS_SE

// Get from console
// =================================================
//#define AWS_IOT_MQTT_HOST             "a2y58yobca0rdm.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_HOST             "your-aws-account.amazonaws.com" // your aws account
...
#define AWS_IOT_ROOT_CA_FILENAME       (char*) AWS_IOT_ROOT_CA
...
/*
// EF (Type A use case):
//  + Certificate is stored in EF (temporary solution, it will later be in mobile IAS applet)
//  + Private key is stored in mobile IAS applet
#define AWS_IOT_CERTIFICATE_FILENAME   MBEDTLS_SE_EF_KEY_NAME_PREFIX "7FAA6F01"
#define AWS_IOT_PRIVATE_KEY_FILENAME   MBEDTLS_SE_EF_KEY_NAME_PREFIX "7FAA6F02"
#define SE_CERTIFICATE_PIN   "1111" // CHV1
#define SE_PRIVATE_KEY_PIN   "1111" // CHV1
*/

/*
// Mobile IAS - P11 storage (Type A' use case):
//  + Certificate is stored in EF (temporary solution, it will later be in mobile IAS applet)
//  + Private key is stored in mobile IAS applet
#define AWS_IOT_CERTIFICATE_FILENAME   MBEDTLS_SE_MIAS_P11_KEY_NAME_PREFIX "CERT_TYPE_B"
#define AWS_IOT_PRIVATE_KEY_FILENAME   MBEDTLS_SE_MIAS_P11_KEY_NAME_PREFIX "PRIV_TYPE_B"
#define SE_CERTIFICATE_PIN   "0000" // MIAS
#define SE_PRIVATE_KEY_PIN   "0000" // MIAS
*/

/*
// @deprecated: only for PoC purpose
// Mobile IAS (Type B use case):
//  + Certificate is stored in EF (temporary solution, it will later be in mobile IAS applet)
//  + Private key is stored in mobile IAS applet  in container #0
#define AWS_IOT_CERTIFICATE_FILENAME   MBEDTLS_SE_EF_KEY_NAME_PREFIX "7FAA6F03"
#define AWS_IOT_PRIVATE_KEY_FILENAME   MBEDTLS_SE_MIAS_KEY_NAME_PREFIX "0"
#define SE_CERTIFICATE_PIN   "1111" // CHV1
#define SE_PRIVATE_KEY_PIN   "0000" // MIAS
*/

// Mobile IAS (Type B' use case):
//  + Certificate is stored in mIAS applet in container #1
//  + Private key is stored in mIAS applet in container #1
#define AWS_IOT_CERTIFICATE_FILENAME   MBEDTLS_SE_MIAS_KEY_NAME_PREFIX "0"
#define AWS_IOT_PRIVATE_KEY_FILENAME   MBEDTLS_SE_MIAS_KEY_NAME_PREFIX "0"
#define SE_CERTIFICATE_PIN   "0000" // MIAS
#define SE_PRIVATE_KEY_PIN   "0000" // MIAS
...
#define AWS_IOT_CERTIFICATE_FILENAME   (char*) AWS_IOT_CERTIFICATE
#define AWS_IOT_PRIVATE_KEY_FILENAME   (char*) AWS_IOT_PRIVATE_KEY

#endif
// =================================================

// To print out more debug information about the TLS connection:
